	...
	return (
		<Fragment>
			...
			<div className="relative lg:p-4 p-2 w-full h-full max-h-[90vh] overflow-x-hidden overflow-y-scroll">
					...
					<div class=" w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
						<div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
							...
							<textarea
								id="comment"
								rows="5"
								class="w-full px-0 text-sm text-gray-900 focus-visible:outline-none bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
				...
				<p class="ml-auto fixed bottom-5 text-xs text-gray-500 dark:text-gray-400">
