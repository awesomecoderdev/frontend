                                ...
                                <form className="p-0" onSubmit={(e) => {handleSubmit(e)}}>
                                    ...
                                    <div className="p-0">
                                        ...
                                        <input
                                            ...
                                            name="email" id="email"
                                            className={`${errors.email ? "border-red-500" : "border-slate-300" } transition bg-gray-50 border focus-visible:outline-none focus-visible:border-slate-400 text-gray-900 text-sm rounded-lg focus:ring-slate-500 focus:border-slate-500 block w-full p-2.5 `}
                                    ...
                                    <div className="p-0">
                                        ...
                                        <input
                                            ...
                                            className={`${errors.password ? "border-red-500" : "border-slate-300" } transition bg-gray-50 border focus-visible:outline-none focus-visible:border-slate-400 text-gray-900 text-sm rounded-lg focus:ring-slate-500 focus:border-slate-500 block w-full p-2.5 `}
                                    ...
                                    <div className="flex items-start my-2 text-slate-500">
                                        <div className="flex items-start">
                                            ...
                                            <label htmlFor="remember" className="ml-2  cursor-pointer text-sm font-medium text-slate-500">
                                                Remember me
                                            </label>
                                        </div>
