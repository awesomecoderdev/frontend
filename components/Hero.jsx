...
const Hero = () => {
	return (
		<section id="hero" className="relative w-full bg-gray-50">
			<div className="relative max-w-7xl flex items-center min-h-screen mx-auto px-20">
				{/* start:left */}
				<div className="relative w-1/2">
					<div className="relative px-10 ">
						<h1 className="text-7xl font-bold text-primary-700/80">
						...
						<div className="relative flex my-10 space-x-5">
							...
							<Link href={"#"} passHref>
								<a className="text-sm text-slate-600 block  px-6 py-3 ">
									<span className="border-b border-slate-500 pb-1">
										Watch Video
									</span>
								</a>
							</Link>
