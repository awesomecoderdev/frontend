	...
	return (
		<Fragment>
			...
			{/* <section className="py-20 lg:py-[120px]">
				<div className="max-w-7xl mx-auto">
					<div className="bg-primary-400 relative z-10 overflow-hidden rounded py-12 px-8 md:p-[70px]">
			...
			{/* start footer */}
			{/* <footer className="pt-32 p-6 bg-gray-800 dark:bg-gray-800 dark:text-gray-100 w-full">
				<div className="max-w-6xl w-full grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4">
					...
					<div className="-mx-4 flex flex-wrap">
						<div className="w-full px-4 sm:w-2/3 lg:w-3/12">
							<div className="mb-10 w-full">
								<a
									href="javascript:void(0)"
									className="relative h-20 w-20 mb-6 inline-block max-w-[160px]"
								>
									<Image
